...
_OBD_CHANNELS = [
    ...
    # CH19: gauge pressure sensor, 0.5–4.5 V output, 0–15 psi, 1 kΩ/590 Ω divider
    #       0 psi→raw≈230, 15 psi→raw≈2072; mn=-1.875 extrapolated to raw=0
    ("Pressure",        "psi",  -1.875, 31.474),   # index 18
